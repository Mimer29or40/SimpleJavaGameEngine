...
public class LOGL_551_ParallaxMapping extends Engine
{
    Program shader;
    ...
    protected LOGL_551_ParallaxMapping()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 5.5.1 - Parallax Mapping");
    ...
    {
        Engine instance = new LOGL_551_ParallaxMapping();
