...
public class LOGL_552_ParallaxMappingSteep extends Engine
{
    Program shader;
    ...
    protected LOGL_552_ParallaxMappingSteep()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 5.5.2 - Parallax Mapping Steep");
    ...
    {
        Engine instance = new LOGL_552_ParallaxMappingSteep();
