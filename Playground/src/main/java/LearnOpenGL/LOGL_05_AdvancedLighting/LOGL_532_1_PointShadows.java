...
public class LOGL_532_1_PointShadows extends Engine // TODO - Is not working
{
    Program shader;
    Program depthShader;
    Program debugShader;
    ...
    // lighting info
    // -------------
    Vector3d lightPos = new Vector3d(0.0f, 0.0f, 0.0f);
    
    boolean shadows = true;
    
    protected LOGL_532_1_PointShadows()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 5.3.2.1 - Point Shadows");
    ...
    {
        Engine instance = new LOGL_532_1_PointShadows();
