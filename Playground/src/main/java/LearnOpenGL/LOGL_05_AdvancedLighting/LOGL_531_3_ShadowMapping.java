...
public class LOGL_531_3_ShadowMapping extends Engine
{
    Program shader;
    Program depthShader;
    ...
    protected LOGL_531_3_ShadowMapping()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 5.3.1.3 - Shadow Mapping");
    ...
    {
        Engine instance = new LOGL_531_3_ShadowMapping();
