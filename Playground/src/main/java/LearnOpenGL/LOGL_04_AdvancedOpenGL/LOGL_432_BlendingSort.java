...
public class LOGL_432_BlendingSort extends Engine
{
    Program shader;
    ...
    protected LOGL_432_BlendingSort()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 4.3.2 - Blending Sort");
    ...
    {
        Engine instance = new LOGL_432_BlendingSort();
