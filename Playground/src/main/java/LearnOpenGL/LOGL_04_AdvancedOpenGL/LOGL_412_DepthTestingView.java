...
public class LOGL_412_DepthTestingView extends Engine
{
    Program shader;
    ...
    protected LOGL_412_DepthTestingView()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 4.1.2 - Depth Testing View");
    ...
    {
        Engine instance = new LOGL_412_DepthTestingView();
