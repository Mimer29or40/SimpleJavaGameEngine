...
public class LOGL_146_TextureExercise4 extends Engine
{
    Program program;
    ...
    protected LOGL_146_TextureExercise4()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 1.4.6 - Texture Exercise 4");
    ...
    protected void update(int frame, double time, double deltaTime)
    {
        ...
        if (keyboardKeyDown(Key.UP) || keyboardKeyRepeated(Key.UP)) if ((mixValue += 0.01) > 1.0) mixValue = 1.0;
        if (keyboardKeyDown(Key.DOWN) || keyboardKeyRepeated(Key.DOWN)) if ((mixValue -= 0.01) < 0.0) mixValue = 0.0;
    }
    ...
    protected void draw(int frame, double time, double deltaTime)
    {
        ...
        Program.uniformFloat("mixValue", mixValue);
    ...
    {
        Engine instance = new LOGL_146_TextureExercise4();
