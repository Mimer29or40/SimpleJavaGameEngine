...
public class LOGL_133_ShadersClass extends Engine
{
    Program program;
    
    VertexArray VAO;
    
    protected LOGL_133_ShadersClass()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 1.3.3 - Shaders Class");
    ...
    {
        Engine instance = new LOGL_133_ShadersClass();
