...
public class LOGL_163_CoordinateSystemsMultiple extends Engine
{
    Program program;
    ...
    protected LOGL_163_CoordinateSystemsMultiple()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 1.6.2 - Coordinate Systems Multiple");
    ...
    protected void draw(int frame, double time, double deltaTime)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            model.rotate(Math.toRadians(20.0 * i), new Vector3d(1.0, 0.3, 0.5));
    ...
    {
        Engine instance = new LOGL_163_CoordinateSystemsMultiple();
