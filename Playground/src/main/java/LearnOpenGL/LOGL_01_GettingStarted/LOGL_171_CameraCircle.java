...
public class LOGL_171_CameraCircle extends Engine
{
    Program program;
    ...
    protected LOGL_171_CameraCircle()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 1.7.1 - Camera Circle");
    ...
    protected void draw(int frame, double time, double deltaTime)
    {
        ...
        double radius = 10.0;
        double camX   = Math.sin(time) * radius;
        double camZ   = Math.cos(time) * radius;
        view.lookAt(new Vector3d(camX, 0.0, camZ), new Vector3d(0.0, 0.0, 0.0), new Vector3d(0.0, 1.0, 0.0));
    ...
    {
        Engine instance = new LOGL_171_CameraCircle();
