...
public class LOGL_175_CameraExercise1 extends Engine
{
    Program program;
    ...
    Camera camera = new Camera(new Vector3d(0, 0, 3), null, null, null);
    
    protected LOGL_175_CameraExercise1()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 1.7.5 - Camera Exercise 1");
    ...
    {
        Engine instance = new LOGL_175_CameraExercise1();
