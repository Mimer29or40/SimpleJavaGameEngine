...
public class LOGL_152_TransformationsExercise1 extends Engine
{
    Program program;
    ...
    protected LOGL_152_TransformationsExercise1()
    {
        super(800, 600);
    }
    ...
    {
        Engine instance = new LOGL_152_TransformationsExercise1();
