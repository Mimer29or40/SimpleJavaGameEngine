...
public class LOGL_161_CoordinateSystems extends Engine
{
    Program program;
    ...
    protected LOGL_161_CoordinateSystems()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 1.6.1 - Coordinate Systems");
    ...
    {
        Engine instance = new LOGL_161_CoordinateSystems();
