...
public class LOGL_135_ShadersExercise2 extends Engine
{
    Program program;
    
    VertexArray VAO;
    
    protected LOGL_135_ShadersExercise2()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 1.3.5 - Shaders Exercise 2");
    ...
    protected void draw(int frame, double time, double deltaTime)
    {
        ...
        double offset = 0.5;
        Program.uniformFloat("xOffset", offset);
    ...
    {
        Engine instance = new LOGL_135_ShadersExercise2();
