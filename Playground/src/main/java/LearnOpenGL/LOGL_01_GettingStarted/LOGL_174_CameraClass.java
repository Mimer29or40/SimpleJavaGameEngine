...
public class LOGL_174_CameraClass extends Engine
{
    Program program;
    ...
    protected LOGL_174_CameraClass()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 1.7.4 - Camera Class");
    ...
    {
        Engine instance = new LOGL_174_CameraClass();
