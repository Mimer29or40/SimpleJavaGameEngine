...
public class LOGL_172_CameraKeyboardDT extends Engine
{
    Program program;
    ...
    protected LOGL_172_CameraKeyboardDT()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 1.7.2 - Camera Keyboard DT");
    ...
    {
        Engine instance = new LOGL_172_CameraKeyboardDT();
