...
public class LOGL_144_TextureExercise2 extends Engine
{
    Program program;
    ...
    protected LOGL_144_TextureExercise2()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 1.4.4 - Texture Exercise 2");
    ...
    {
        Engine instance = new LOGL_144_TextureExercise2();
