...
public class LOGL_142_TextureCombined extends Engine
{
    Program program;
    ...
    protected LOGL_142_TextureCombined()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 1.4.2 - Texture Combined");
    ...
    {
        Engine instance = new LOGL_142_TextureCombined();
