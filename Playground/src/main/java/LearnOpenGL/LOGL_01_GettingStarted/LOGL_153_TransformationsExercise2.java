...
public class LOGL_153_TransformationsExercise2 extends Engine
{
    Program program;
    ...
    protected LOGL_153_TransformationsExercise2()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 1.5.2 - Transformations Exercise 1");
    ...
    {
        Engine instance = new LOGL_153_TransformationsExercise2();
