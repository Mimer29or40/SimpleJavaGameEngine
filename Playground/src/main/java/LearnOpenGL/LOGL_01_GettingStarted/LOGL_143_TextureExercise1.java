...
public class LOGL_143_TextureExercise1 extends Engine
{
    Program program;
    ...
    protected LOGL_143_TextureExercise1()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 1.4.3 - Texture Exercise 1");
    ...
    {
        Engine instance = new LOGL_143_TextureExercise1();
