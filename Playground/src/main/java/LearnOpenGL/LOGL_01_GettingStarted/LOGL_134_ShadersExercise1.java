...
public class LOGL_134_ShadersExercise1 extends Engine
{
    Program program;
    
    VertexArray VAO;
    
    protected LOGL_134_ShadersExercise1()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 1.3.4 - Shaders Exercise 1");
    ...
    {
        Engine instance = new LOGL_134_ShadersExercise1();
