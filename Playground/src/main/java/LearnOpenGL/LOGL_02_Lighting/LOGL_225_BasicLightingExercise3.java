...
public class LOGL_225_BasicLightingExercise3 extends Engine
{
    ...
    protected LOGL_225_BasicLightingExercise3()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 2.2.5 - Basic Lighting Exercise 3");
    ...
    {
        Engine instance = new LOGL_225_BasicLightingExercise3();
