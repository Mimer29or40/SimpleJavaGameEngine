...
public class LOGL_251_LightCastersDirectional extends Engine
{
    ...
    protected LOGL_251_LightCastersDirectional()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 2.5.1 - Light Casters Directional");
    ...
    protected void draw(int frame, double time, double deltaTime)
    {
        ...
        Program.uniformFloat3("light.direction", -0.2, -1.0, -0.3);
    ...
    {
        Engine instance = new LOGL_251_LightCastersDirectional();
