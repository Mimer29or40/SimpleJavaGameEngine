...
public class LOGL_232_MaterialsExercise1 extends Engine
{
    ...
    protected LOGL_232_MaterialsExercise1()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 2.3.2 - Materials Exercise 1");
    ...
    protected void draw(int frame, double time, double deltaTime)
    {
        ...
        // light properties
        Program.uniformFloat3("light.ambient", 1.0, 1.0, 1.0);
        Program.uniformFloat3("light.diffuse", 1.0, 1.0, 1.0);
        Program.uniformFloat3("light.specular", 1.0, 1.0, 1.0);
        
        // material properties
        Program.uniformFloat3("material.ambient", 0.0, 0.1, 0.06);
        Program.uniformFloat3("material.diffuse", 0.0, 0.50980392, 0.50980392);
        Program.uniformFloat3("material.specular", 0.50196078, 0.50196078, 0.50196078);
    ...
    {
        Engine instance = new LOGL_232_MaterialsExercise1();
