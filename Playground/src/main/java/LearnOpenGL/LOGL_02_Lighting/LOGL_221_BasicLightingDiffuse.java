...
public class LOGL_221_BasicLightingDiffuse extends Engine
{
    ...
    protected LOGL_221_BasicLightingDiffuse()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 2.2.1 - Basic Lighting Diffuse");
    ...
    {
        Engine instance = new LOGL_221_BasicLightingDiffuse();
