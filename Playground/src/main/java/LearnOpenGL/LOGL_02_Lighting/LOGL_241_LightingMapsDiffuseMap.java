...
public class LOGL_241_LightingMapsDiffuseMap extends Engine
{
    ...
    protected LOGL_241_LightingMapsDiffuseMap()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 2.4.1 - Lighting Maps Diffuse Map");
        ...
        Image image = new Image(IOUtil.getPath("LearnOpenGL/textures/container2.png"));
        
        diffuseMap = new Texture2D(image);
    ...
    protected void draw(int frame, double time, double deltaTime)
    {
        ...
        Program.uniformFloat3("material.specular", 0.5, 0.5, 0.5);
    ...
    {
        Engine instance = new LOGL_241_LightingMapsDiffuseMap();
