...
public class LOGL_222_BasicLightingSpecular extends Engine
{
    ...
    protected LOGL_222_BasicLightingSpecular()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 2.2.2 - Basic Lighting Specular");
    ...
    {
        Engine instance = new LOGL_222_BasicLightingSpecular();
