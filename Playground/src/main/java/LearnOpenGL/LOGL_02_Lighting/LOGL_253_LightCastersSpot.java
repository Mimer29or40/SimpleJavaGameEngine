...
public class LOGL_253_LightCastersSpot extends Engine
{
    ...
    protected LOGL_253_LightCastersSpot()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 2.5.3 - Light Casters Spot");
    ...
    {
        Engine instance = new LOGL_253_LightCastersSpot();
