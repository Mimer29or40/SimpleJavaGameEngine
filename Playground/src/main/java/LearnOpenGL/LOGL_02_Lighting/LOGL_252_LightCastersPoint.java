...
public class LOGL_252_LightCastersPoint extends Engine
{
    ...
    protected LOGL_252_LightCastersPoint()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 2.5.2 - Light Casters Point");
    ...
    {
        Engine instance = new LOGL_252_LightCastersPoint();
