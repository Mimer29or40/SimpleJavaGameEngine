...
public class LOGL_243_LightingMapsExercise2 extends Engine
{
    ...
    protected LOGL_243_LightingMapsExercise2()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 2.4.3 - Lighting Maps Exercise 2");
    ...
    {
        Engine instance = new LOGL_243_LightingMapsExercise2();
