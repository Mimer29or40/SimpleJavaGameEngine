...
public class LOGL_242_LightingMapsSpecularMap extends Engine
{
    ...
    protected LOGL_242_LightingMapsSpecularMap()
    {
        super(800, 600);
    }
    ...
    {
        windowTitle("LearnOpenGL - 2.4.2 - Lighting Maps Specular Map");
    ...
    {
        Engine instance = new LOGL_242_LightingMapsSpecularMap();
